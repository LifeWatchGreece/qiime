...
<div style="font-weight: bold; font-size: 18px; text-align: center; margin: 20px">Genetics vLab Storage Policy</div>
...
<p>
   ...
   This will be called "soft limit". More space can be used by users but in case Genetics vLab runs out of storage, jobs 
...
<div style="font-weight: bold; font-size: 18px; text-align: center; margin: 20px">Genetics vLab Usage Policy</div>

<p>
    1. The first time you are going to visit Genetics vLab you will be asked to register as an Genetics vLab user for 
    a certain period. You have to select among fixed choices like "1 day", "1 week", "1 month" etc. Please, 
    select the one that better respresents your intentions. For example, if your are just visiting Genetics vLab 
    to check out what this lab is about, then select "1 day" or "1 week". This registration is vital in order 
    to be able to provide a minimum quality of service to every Genetics vLab user. When the period that you have
