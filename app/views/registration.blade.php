...
<div style="font-weight: bold; font-size: 20px; text-align: center; margin: 20px">Genetics vLab Registration <span style="font-weight: normal; color: gray">(Select and submit. That's it!)</span></div>
<div style="margin-left: 30px">
    ...
    <table class="reg_period_table">
        <tr>
            <td>Please, provide me access to Genetics vLab for:</td>
            <td>
                <div class="radio">
                    <label>
...
<div style="color: gray; margin: 20px">
    ...
    if you are requesting short-term access only to try or check out the Genetics vLab functionality, select the "1 day". Making such a selection
